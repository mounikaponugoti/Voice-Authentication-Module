...
#Source: https://github.com/pierre-rouanet/dtw
...
def sdtw(x, y, dist=lambda x, y: norm(x - y, ord=1)):
...
def dtw(x, y, dist):
    ...
    ''' To debug
    print("x : row = "+str(len(x)))
    print("x : col = "+str(len(x[0])))
    print("y : row = "+str(len(y)))
    print("y : col = "+str(len(y[0])))
    print("x : shape = "+str(len(x.shape)))
    print("y : shape = "+str(len(y.shape)))'''
